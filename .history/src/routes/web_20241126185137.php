...
Route::get('/admin/login', [LoginController::class, 'loginView'])->name('admin.loginView');
Route::prefix('admin')->group(function(middleware('auth:administrators')->group(function(){
