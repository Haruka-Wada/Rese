...
<div class="main__container">
    ...
    <div class="reservation__container">
        <div class="reservation__wrap">
            ...
            <form action="/reservation" method="post" id="reservation">
                ...
                <div class="reservation__confirm">
                    ...
                    <dl class="reservation__confirm-list">
                        <dt class="reservation__confirm-item" id="time">Time</dt>
                        <dd class="reservation__confirm-content"></dd>
                    </dl>
                    <dl class="reservation__confirm-list">
        ...
        <div class="reservation__button" form="reservation">
            <button>予約する</button>
        </div>
    </div>
<script type="text/javascript">
    $(function() {
        ...
        $('[name=time]').change(function() {
            let selectedTime = $('[name=time] option:selected').text();
