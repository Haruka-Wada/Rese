            ...
            <div class="card__content">
                ...
                <div class="card__content-detail">
                    ...
                    <div class="card__content-detail-fav">
                        ...
                        <img class="like-toggle like" src=" {{ asset('img/heart.png') }}" alt="お気に入りボタン" data-shop-id="{{ $shop->id }}">
                        @else
                        <img class="like-toggle liked" src="{{ asset('img/heart_red.png') }}" alt="お気に入りボタン">
                        @endif
                        @endauth
                    </div>
                    @guest
