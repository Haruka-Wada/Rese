        ...
        <div class="header__overlay">
            <div class="header__wrapper">
                ...
                <div class="header__search">
                    <select name="" id="" class="header__search-area">
                    <select name="" id="" class="header__sear"></select>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        $(function() {
            $('.header__hamburger').click(function() {
                $('.header__overlay,.header__wrapper,.header__hamburger,.header__logo,.menu__overlay,.main__overlay').toggleClass('active');
            });
        });
    </script>
</body>
