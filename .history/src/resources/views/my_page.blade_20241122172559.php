...
<div class="main__wrapper">
    ...
    <div class="main__container">
        <div class="reservations__container">
            ...
            <div class="reservations__container-contents">
                ...
                <div class="reservation__card">
                    ...
                    <div class="reservation__card-button">
                        @if($reservation->date->isToday() || $reservation->date->isFuture())
        ...
        <div class="favorites__container">
            ...
            <div class="favorites__container-contents">
                ...
                <div class="favorite__card">
                    ...
                    <div class="favorite__card-content">
                        ...
                        <div class="favorite__card-content-tag">
                            <span>#{{ $favorite->shop->area->name }}</span>
                            <span>#{{ $favorite->shop->genre->name }}</span>
                        </div>
                        <div class="favorite__card-content-detail">
                            <div class="favorite__card-content-detail-link">
                                <form action="/detail/" method="get">
                                    <input type="hidden" name="shop_id" value="{{ $favorite->shop_id }}">
                                    <button>詳しくみる</button>
                                </form>
                            </div>
                            <div class="favorite__card-content-detail-fav">
