        ...
        <div class="review__wrap">
            ...
            <form action="/score" method="post" id="score">
                ...
                <div class="review__form">
                    ...
                    <label class="review__score-label" for="rating{{$i}}"><img src="{{asset('img/star.png')}}" alt="star"></label>
                    @endfor
                ...
                <textarea class="review__comment" placeholder="店舗へのコメントを記入してください。"></textarea>
            </form>
