        ...
        <div class="card">
            ...
            <div class="card__content">
                ...
                <div class="card__content-detail">
                    ...
                    <div class="card__content-detail-fav data-shop-id=" {{ $shop->id }}">
                        @auth
                        @if(!$shop->isLikedBy(Auth::user()))
                        <img class="like-toggle"" src=" {{ asset('img/heart.png') }}" alt="">
                        @else
                        <img class="heart" src="{{ asset('img/heart_red.png') }}" alt="">
                        @endif
                        @endauth
                    </div>
                    @guest
