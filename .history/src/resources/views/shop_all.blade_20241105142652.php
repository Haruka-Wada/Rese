        ...
        <div class="card">
            ...
            <div class="card__content">
                ...
                <div class="card__content-detail">
                    ...
                    @auth
                    @if(!$->isLikedBy(Auth::user()))
                    <div class="card__content-detail-fav like-toggle" date-shop-id="{{ $shop->id }}">
                        <img src="{{ asset('img/heart.png') }}" alt="">
                    </div>
                    @else
                    <div class="card__content-detail-fav like-toggle liked" date-shop-id="{{ $shop->id }}">
                        <img src="{{ asset('img/heart_red.png') }}" alt="">
                    </div>
                    @endif
                    @endauth
                    @guest
